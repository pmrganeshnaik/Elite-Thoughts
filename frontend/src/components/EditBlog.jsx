...
import { Save, ArrowLeft, Pencil, FileText, User, Tag, MessageSquare } from "lucide-react";
    ...
    return (
      <div className="container mx-auto px-4 py-12 flex justify-center items-center h-64">
        <div className="flex items-center space-x-2">
          ...
          <p className="text-[#0A192F] font-medium ml-2">Loading blog data...</p>
        </div>
      </div>
    );
  }
  ...
  if (!data || !Array.isArray(data) || data.length === 0) {
    return (
      <div className="text-center py-12 bg-white rounded-lg shadow-md max-w-2xl mx-auto">
        <h1 className="text-2xl font-serif font-bold text-[#0A192F]">Blog not found</h1>
        <p className="mt-4 text-[#0A192F]/70">The blog post you're trying to edit might have been moved or deleted.</p>
        <button 
      ...
      <div className="bg-white rounded-lg shadow-lg overflow-hidden">
        <div className="p-6 md:p-8">
          <div className="flex items-center mb-6">
            ...
            <h1 className="text-[#0A192F] text-2xl md:text-3xl font-serif font-bold">Edit Blog Post</h1>
          </div>
          
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              <label htmlFor="title" className="flex items-center text-sm font-medium text-[#0A192F]">
            ...
            <div className="space-y-2">
              <label htmlFor="author" className="flex items-center text-sm font-medium text-[#0A192F]">
            ...
            <div className="space-y-2">
              <label htmlFor="category" className="flex items-center text-sm font-medium text-[#0A192F]">
            ...
            <div className="space-y-2">
              <label htmlFor="content" className="flex items-center text-sm font-medium text-[#0A192F]">
